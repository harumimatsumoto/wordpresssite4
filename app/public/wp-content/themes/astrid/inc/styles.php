...
function simpledesign_hex2rgba($color, $opacity = false) {
...
//Dynamic styles
function simpledesign_custom_styles($custom) {
	...
	$menu_rgba 	= simpledesign_hex2rgba($menu_bg, 0.9);
	...
	wp_add_inline_style( 'simpledesign-style', $custom );	
}
add_action( 'wp_enqueue_scripts', 'simpledesign_custom_styles' );